"use strict";
/* build-hook-start *//*00001*/try { require('/home/josecicero/.vscode/extensions/wallabyjs.console-ninja-1.0.432/out/buildHook/index.js').default({tool: 'nest.js', checkSum: '20c4ba52ce72685d9de944SRpITx8IVFVSBQAIBAUOUFcJDFVS', mode: 'runtime'}); } catch(cjsError) { try { import('file:///home/josecicero/.vscode/extensions/wallabyjs.console-ninja-1.0.432/out/buildHook/index.js').then(m => m.default.default({tool: 'nest.js', checkSum: '20c4ba52ce72685d9de944SRpITx8IVFVSBQAIBAUOUFcJDFVS', mode: 'runtime'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
