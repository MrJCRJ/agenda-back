"use strict";
/* build-hook-start *//*00001*/try { require('/home/josecicero/.vscode/extensions/wallabyjs.console-ninja-1.0.440/out/buildHook/index.js').default({tool: 'nest.js', checkSum: '20e25c55a95ed4200b06bfTxwfTR8PWQsMU1IBBghSAFMGUFUA', mode: 'runtime'}); } catch(cjsError) { try { import('file:///home/josecicero/.vscode/extensions/wallabyjs.console-ninja-1.0.440/out/buildHook/index.js').then(m => m.default.default({tool: 'nest.js', checkSum: '20e25c55a95ed4200b06bfTxwfTR8PWQsMU1IBBghSAFMGUFUA', mode: 'runtime'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
